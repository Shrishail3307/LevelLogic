    ...
    <header className="flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 border-b border-hairline bg-canvas px-6">
      <div className="flex items-center gap-2 flex-1">
        ...
        <Separator
          ...
          className="mr-4 data-[orientation=vertical]:h-4 bg-hairline"
        />
        <div className="flex flex-col">
          <h1 className="text-sm font-medium text-ink tracking-tight flex items-center gap-2">
            Console Center
            <span className="label-mono px-1.5 py-0.5 rounded-sm bg-enterprise-green text-[9px] font-bold text-white tracking-widest">
              Secure
            </span>
          </h1>
      ...
      <div className="flex items-center gap-4">
        <div className="hidden md:flex items-center gap-2 px-4 h-9 bg-stone/50 border border-hairline rounded-full text-muted-slate group cursor-pointer hover:border-action-blue transition-all">
          ...
          <span className="text-xs font-medium">System query...</span>
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-hairline">
          <div className="flex flex-col items-end hidden sm:flex">
            ...
            <span className="label-mono text-[9px] text-enterprise-green">
              Root Authority
            </span>
          </div>
          <div className="w-9 h-9 rounded-full bg-near-black flex items-center justify-center overflow-hidden">
